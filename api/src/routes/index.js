...
router.get('/dogs_cut', async (req, res)=> {
...
router.get('/temperaments', async (_req, res) => {
    ...
    const temp_cut = temperaments_sin_dividir.slice(0, 5)
    const temperaments_finals = temp_cut.toString().replace(/ /g, "").split(',');
    console.log(temperaments_finals)
    console.log("acá estoy", temp_cut)
