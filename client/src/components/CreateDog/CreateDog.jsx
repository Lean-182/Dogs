...
const validate = (input) => {
    ...
    } else if (parseInt(input.pesoMin) < 0 || parseInt(input.pesoMax) > 80) {
        errors.peso = 'El peso no puede ser menor a 0 Kg ni mayor a 80 Kg'
    ...
    } else if (input.imagen.length > 300) {
        errors.imagen = 'La URL ingresada debe ser menor a 300 caracteres';
    }
